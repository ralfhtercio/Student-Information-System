...
class SearchStudentFrame:
    def __init__(self, frame):
        ...
        self.search_bar_entry = Entry(self.search_frame, highlightthickness=2, highlightbackground="#A5678E",
                                      font=("Tw Cen MT", 18))
        self.srch_btn_img = PhotoImage(file=r"search_img.png")
...
class StudentGUI:
    def __init__(self, frame):
        ...
        self.home_img = PhotoImage(file="home_img.png")
        ...
        self.head_bldsgn_img = PhotoImage(file=r"design_img.png")
        ...
        # Navigation buttons
        self.add_button_img = PhotoImage(file=r"addstud.png").subsample(6, 6)
        self.edit_button_img = PhotoImage(file=r"editstud.png").subsample(6, 6)
        self.delete_button_img = PhotoImage(file=r"deletestud.png").subsample(6, 6)
        self.search_button_img = PhotoImage(file=r"searchstud.png").subsample(6, 6)
        ...
        about = "This application is a simple student information system \nthat lets the user \n\n\u2713 VIEW STUDENTS' LIST,\n\u2713 ADD A STUDENT" \
                "\n\u2713 EDIT A STUDENT, \n\u2713 DELETE A STUDENT, and \n\u2713 SEARCH A STUDENT WITH ID NUMBER. \n\n" 
        self.about = Text(self.about_frame, bg="#99FADC", fg="#343535", highlightcolor="#99FADC",
                          highlightthickness=0, font=("Comic Sans MS", 13), relief=FLAT)
        self.about.insert(INSERT, about)
        self.about.config(state=DISABLED)
        self.author = Label(self.about_frame, fg="#343535", bg="#99FADC", font=("Comic Sans MS", 12),
